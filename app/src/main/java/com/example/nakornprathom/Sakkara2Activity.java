...
public class Sakkara2Activity extends AppCompatActivity {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.nav_home) {
                    intent = new Intent(Sakkara2Activity.this, HomeActivity.class);
                } else if (item.getItemId() == R.id.nav_about) {
                    intent = new Intent(Sakkara2Activity.this, AboutActivity.class);
                } else if (item.getItemId() == R.id.nav_sakkara) {
                    intent = new Intent(Sakkara2Activity.this, SakkaraActivity.class);
                } else if (item.getItemId() == R.id.nav_festival) {
                    intent = new Intent(Sakkara2Activity.this, FestivalActivity.class);
                } else if (item.getItemId() == R.id.nav_contact) {
                    intent = new Intent(Sakkara2Activity.this, ContactActivity.class);
                }
    ...
    private void updateUI() {
        ...
        subtitleText.setText(R.string.phra_ruang);
        startButton.setText(R.string.point_3);
