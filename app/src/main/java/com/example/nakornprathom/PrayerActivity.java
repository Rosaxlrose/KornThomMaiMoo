        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    // เปิด AboutActivity
                    startActivity(new Intent(PrayerActivity.this, AboutActivity.class));
                } else if (id == R.id.nav_sakkara) {
                    // เปิด sakkaraActivity
                    startActivity(new Intent(PrayerActivity.this, SakkaraActivity.class));
                }else if (id == R.id.nav_prayer) {
                    // เปิด prayerActivity
                    startActivity(new Intent(PrayerActivity.this, PrayerActivity.class));
                }else if (id == R.id.nav_festival) {
                    // เปิด festivalActivity
                    startActivity(new Intent(PrayerActivity.this, FestivalActivity.class));
                }else if (id == R.id.nav_contact) {
                    // เปิด contactActivity
                    startActivity(new Intent(PrayerActivity.this, ContactActivity.class));
                }
