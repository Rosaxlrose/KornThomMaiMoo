    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (item.getItemId() == R.id.nav_home) {
                intent = new Intent(FestivalActivity.this, HomeActivity.class);
            } else if (item.getItemId() == R.id.nav_about) {
                intent = new Intent(FestivalActivity.this, AboutActivity.class);
            } else if (item.getItemId() == R.id.nav_sakkara) {
                intent = new Intent(FestivalActivity.this, SakkaraActivity.class);
            } else if (item.getItemId() == R.id.nav_festival) {
                intent = new Intent(FestivalActivity.this, FestivalActivity.class);
            } else if (item.getItemId() == R.id.nav_contact) {
                intent = new Intent(FestivalActivity.this, ContactActivity.class);
            }
