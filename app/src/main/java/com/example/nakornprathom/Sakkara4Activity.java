...
public class Sakkara4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sakkara4);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.nav_home) {
                    intent = new Intent(Sakkara4Activity.this, HomeActivity.class);
                } else if (item.getItemId() == R.id.nav_about) {
                    intent = new Intent(Sakkara4Activity.this, AboutActivity.class);
                } else if (item.getItemId() == R.id.nav_sakkara) {
                    intent = new Intent(Sakkara4Activity.this, SakkaraActivity.class);
                } else if (item.getItemId() == R.id.nav_festival) {
                    intent = new Intent(Sakkara4Activity.this, FestivalActivity.class);
                } else if (item.getItemId() == R.id.nav_contact) {
                    intent = new Intent(Sakkara4Activity.this, ContactActivity.class);
                }
        ...
        // คลิกปุ่มไปหน้า Sakkara5Activity
        startButton.setOnClickListener(view -> {
            Intent intent = new Intent(Sakkara4Activity.this, Sakkara5Activity.class);
            startActivity(intent);
        });

        // คลิกปุ่มกลับไป Sakkara3Activity
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(Sakkara4Activity.this, Sakkara3Activity.class);
            startActivity(intent);
            finish();
        });
    ...
    private void updateUI() {
        ...
        subtitleText.setText(R.string.goddess_umadevi);
        startButton.setText(R.string.point_5);
